...
![](../img/DaleChu/dmz_success.png)

![](../img/DaleChu/dps_dmz.png)

这里发现镜像 `vulfocus/struts2-cve_2020_17530` 对应容器的 CONTAINER ID 为 `1fb64118ab50`, 下面尝试捕获指定容器的上下行流量 :

```shell
# 建议放到 tmux 会话
container_name="1fb64118ab50"
docker run --rm --net=container:${container_name} -v ${PWD}/tcpdump/${container_name}:/tcpdump kaazing/tcpdump

# 置于后台, 快捷键 Ctrl + B, D
```

![](../img/DaleChu/tmux_713.png)

![](../img/DaleChu/the_id.png)
...
部署 DMZ 场景, 一直失败. 请教老师后, 发现我的两位室友也都遇到了同样的问题哈哈, 需要自己写一个 dockerfile, 将 vulshare/nginx-php-flag 容器中的 /2.sh 的 ping 命令删去即可. 
